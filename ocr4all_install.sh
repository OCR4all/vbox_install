...
# Install dependencies system-wide and delete cache
apt-get update && apt get install -y \
locales git wget openjdk-8-jdk-headless tomcat8 python2.7 python3-pip \
 python3-pil maven python-tk supervisor python-pip 
...
# Download maven project
	...
	cd /var/lib/tomcat8/webapps && \
    	wget $ARTIFACTORY_URL/OCR4all_Web/$OCR4ALL_VERSION/OCR4all_Web-$OCR4ALL_VERSION.war -O OCR4all_Web.w$
